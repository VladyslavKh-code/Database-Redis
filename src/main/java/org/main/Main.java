...
public class Main {
    ...
    private List<CityCountry> transformData(List<City> cities) {
        return cities.stream().map(city -> {
            ...
            res.setAlternativeCountryCode(country.getCodeSecond());
    ...
    public static void main(String[] args) {
        ...
        List<CityCountry> getAllData = main.transformData(allCities);
        main.pushToRedis(getAllData);
        // main.shutdown();


        main.sessionFactory.getCurrentSession().close();

        List<Integer> ids = List.of(13, 2545, 1233, 423, 1829, 819, 3458, 1189, 10, 102);
